...
** Last update Sat Jan 16 21:09:57 2016 Alexis Viguié
*/
...
char	*gnl_strcpy(char *param_string, char do_free_src)
{
  char	*ret_string;
  int	counter;
...
char			*get_next_line(int fd)
{
  ...
  lastread = gnl_strcpy(&ret_gnl[gnl_op(ret_gnl, 'c') + 1], 'n');
  gnl_call_count++;
